  ...
  load_balancer "my-load-balancer-2", :internal => true do
    ...
    listeners do
      ...
      listener [:https, 443] => [:http, 80] do
        ...
        ssl_negotiation ["Protocol-TLSv1", "Protocol-SSLv3", "AES256-SHA", "DES-CBC3-SHA", "AES128-SHA", "RC4-SHA", "RC4-MD5", "DES-CBC-MD5", "DES-CBC3-MD5"]
...
ec2 do
  load_balancer "my-load-balancer" do
    ...
    listeners do
      listener [:http, 80] => [:http, 80] do
        lb_cookie_stickiness "CookieExpirationPeriod"=>"20"
      end
      listener [:https, 443] => [:http, 80] do
        app_cookie_stickiness "CookieName"=>"20"
        ssl_negotiation ["Protocol-TLSv1", "Protocol-SSLv3", "AES256-SHA", "DES-CBC3-SHA", "AES128-SHA", "RC4-SHA", "RC4-MD5", "DES-CBC-MD5"]
        server_certificate "test1"
      end
    end
...
ec2 "vpc-c1cbc2a3" do
  load_balancer "my-load-balancer-1" do
    ...
    listeners do
      ...
      listener [:https, 443] => [:http, 80] do
        lb_cookie_stickiness "CookieExpirationPeriod"=>"11"
        ssl_negotiation ["Protocol-TLSv1", "Protocol-SSLv3", "AES256-SHA", "DES-CBC3-SHA", "AES128-SHA", "RC4-SHA", "RC4-MD5", "DES-CBC3-MD5"]
        server_certificate "test2"
      end
    end
...
ec2 "vpc-cbcbc2a9" do
  load_balancer "my-load-balancer-2", :internal => true do
    ...
    listeners do
      listener [:http, 80] => [:http, 80] do
        app_cookie_stickiness "CookieName"=>"25"
      end
      listener [:https, 443] => [:http, 80] do
        lb_cookie_stickiness "CookieExpirationPeriod"=>"15"
        ssl_negotiation ["Protocol-TLSv1", "Protocol-SSLv3", "AES256-SHA", "DES-CBC3-SHA", "AES128-SHA", "RC4-SHA", "RC4-MD5"]
        server_certificate "test3"
      end
    end
      ...
      [{:protocol=>:http,
        ...
        :policies=>
         [{:name=>
           ...
           :attributes=>{"CookieExpirationPeriod"=>["20"]}}]},
       {:protocol=>:https,
        :port=>443,
        :instance_protocol=>:http,
        :instance_port=>80,
 ...
 "vpc-cbcbc2a9"=>
  {"my-load-balancer-2"=>
       ...
       {:protocol=>:https,
        ...
        :policies=>
         [{:name=>
           ...
           :type=>"LBCookieStickinessPolicyType",
           :attributes=>{"CookieExpirationPeriod"=>["15"]}},
          {:name=>
    ...
    AWS.memoize do
      ...
      my_load_balancer_policies = get_policies.call('my-load-balancer')
      ...
      my_load_balancer_1_policies = get_policies.call('my-load-balancer-1')
      ...
      my_load_balancer_2_policies = get_policies.call('my-load-balancer-2')
