...
{nil=>
  {"my-load-balancer"=>
    {:instances=>["i-cd1c8a91", "i-e01086bc", "i-e11086bd", "i-e21086be"],
     ...
     :attributes=>{:access_log=>{:enabled=>false}, :cross_zone_load_balancing=>{:enabled=>true}, :connection_draining=>{:enabled=>false, :timeout=>300}},
    ...
    {:instances=>["i-113d714e", "i-123d714d", "i-4869ff14", "i-4969ff15"],
     ...
     :health_check=>
      {:interval=>30,
       ...
       :unhealthy_threshold=>10},
     :scheme=>"internal",
     :attributes=>{:access_log=>{:enabled=>false}, :cross_zone_load_balancing=>{:enabled=>false}, :connection_draining=>{:enabled=>false, :timeout=>300}},
     :dns_name=>
